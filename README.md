# Description
This libary is a fork from [declaration-bundler-webpack-plugin](https://github.com/smol/declaration-bundler-webpack-plugin) and published as dts-bundler-webpack-plugin. This fork adds option `namespace` next to `moduleName`, which will generate module or namespace, depending on what you set. There are some other improvements around exports and imports. 
